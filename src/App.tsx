    ...
    <div className="selection:bg-accent/30 selection:text-primary relative min-h-screen overflow-x-hidden">
      ...
      <footer className="dark:bg-darkSurface relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-white px-6 transition-colors duration-1000">
        ...
        <div className="relative z-10 container mx-auto flex max-w-4xl flex-col items-center gap-12 md:gap-24">
          ...
          <div className="space-y-6 text-center md:space-y-16">
            ...
            <div className="flex flex-col items-center gap-4 border-t border-slate-100 pt-4 md:gap-10 md:pt-28 dark:border-white/5">
              {/* Signature */}
              ...
              <p className="mt-2 text-[10px]">
                {WEDDING_TEXT.closing.family.map((item, idx) => (
          ...
          <div className="flex h-32 flex-col items-center gap-4 border-t border-slate-100 pt-2 md:gap-10 md:pt-28 dark:border-white/5">
            {/* Signature */}
            <p className="text-[9px] font-black uppercase md:text-[13px]">
